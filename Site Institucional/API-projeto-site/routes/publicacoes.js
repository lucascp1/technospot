...
/* ROTA QUE RECUPERA AS MAIS INSERIDAS */
  router.get('/agrupado', function (req, res, next) {
    console.log('Recuperando todas as publicações');

    let instrucaoSql = `SELECT tbIndicacoes.nomeArtista, 
    tbIndicacoes.nomeMusica, 
    COUNT(nomeMusica) as 'qtdMusica' 
    FROM tbIndicacoes 
    GROUP BY nomeMusica 
